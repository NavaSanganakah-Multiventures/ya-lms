...
CREATE TABLE IF NOT EXISTS Courses (
      ...
      individual_class_cost_paise INTEGER DEFAULT 0,
      trial_upgrade_price_paise INTEGER,
...
CREATE TABLE IF NOT EXISTS Batches (
      ...
      cost_per_class_paise INTEGER DEFAULT 0,
      live_class_cost_per_minute_paise INTEGER DEFAULT 0,
      live_class_credit_unit TEXT DEFAULT 'class',
      credit_deduction_timing TEXT DEFAULT 'on_join',
      no_show_charge_paise INTEGER DEFAULT 200,
...
CREATE TABLE IF NOT EXISTS IndividualBookings (
      ...
      amount_charged_paise INTEGER DEFAULT 0,
      amount_refunded_paise INTEGER DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS CreditWallets (
      ...
      lifetime_deposits_paise INTEGER NOT NULL DEFAULT 0,
      lifetime_withdrawals_paise INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS Subscriptions (
      ...
      status TEXT DEFAULT 'created',
      live_class_amount_paise INTEGER DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS SubscriptionPlans (
      ...
      wallet_amount_paise INTEGER DEFAULT 0,
      live_session_access INTEGER DEFAULT 0,
      live_class_amount_paise INTEGER DEFAULT 0,
      is_lifetime INTEGER DEFAULT 0,
      lifetime_price_paise INTEGER DEFAULT 0,
      is_active INTEGER DEFAULT 1,
      created_at DATETIME DEFAULT CURRENT_TIMESTAMP
    );

...
CREATE INDEX IF NOT EXISTS idx_pushsubscriptions_device_id ON PushSubscriptions(device_id);
CREATE INDEX IF NOT EXISTS idx_pushsubscriptions_fcm_token ON PushSubscriptions(fcm_token);
CREATE INDEX IF NOT EXISTS idx_pushsubscriptions_endpoint ON PushSubscriptions(endpoint);

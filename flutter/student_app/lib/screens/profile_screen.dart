        ...
        child: ResponsiveLayout(
          child: ListView(
            ...
            children: [
              ...
              Text(name, textAlign: TextAlign.center, style: const TextStyle(color: AppTheme.textPrimary, fontSize: 26, fontWeight: FontWeight.w900), maxLines: 1, overflow: TextOverflow.ellipsis),
              const SizedBox(height: 8),
              Text(email, textAlign: TextAlign.center, style: const TextStyle(color: AppTheme.muted, fontSize: 16), maxLines: 2, overflow: TextOverflow.ellipsis),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(subtitle, style: const TextStyle(color: AppTheme.muted, fontSize: 13), maxLines: 2, overflow: TextOverflow.ellipsis),
                ],
              ),
            ),

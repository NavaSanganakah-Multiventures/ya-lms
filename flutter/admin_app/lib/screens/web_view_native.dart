...
class AdminWebViewImpl extends StatefulWidget {
  final Uri uri;
  final String title;
  ...
  @override
  State<AdminWebViewImpl> createState() => _AdminWebViewImplState();
}

class _AdminWebViewImplState extends State<AdminWebViewImpl> {

...
const legalContent: any = {
  privacy: {
    ...
    content: `
      NavaSanganakah LMS ("हम", "हमें", "हमारा") आपकी गोपनीयता का सम्मान करता है और आपकी व्यक्तिगत जानकारी की सुरक्षा के लिए प्रतिबद्ध है। यह नीति बताती है कि हम आपकी जानकारी कैसे एकत्र करते हैं और उसका उपयोग कैसे करते हैं।
  ...
  terms: {
    ...
    content: `
      NavaSanganakah LMS की वेबसाइट और सेवाओं का उपयोग करके, आप निम्नलिखित शर्तों से सहमत होते हैं:

      1. खाता पंजीकरण: आपको सटीक जानकारी प्रदान करनी होगी और अपना पासवर्ड सुरक्षित रखना होगा।
      2. पाठ्यक्रम सामग्री: सभी सामग्री NavaSanganakah LMS की संपत्ति है और इसे बिना अनुमति के साझा या डाउनलोड नहीं किया जा सकता।

            ...
            {data.enrolledCourses.map((course: any) => (
              <div key={course.id} className="group flex flex-col bg-neutral-900 border border-neutral-800 rounded-3xl overflow-hidden hover:border-orange-500/50 transition-all hover:shadow-2xl hover:shadow-orange-500/10">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  {Number(course.price_rupees || 0) > 0 && (
                    <div className="mt-3 flex flex-wrap gap-2">
                      <span className="inline-flex items-center gap-1 rounded-full border border-orange-500/20 bg-orange-500/10 px-2.5 py-1 text-[10px] font-black uppercase tracking-widest text-orange-300">
                        <Wallet className="h-3 w-3" /> ₹{course.price_rupees}
                      </span>
                    </div>
                  )}
                   ...
                   <div className="absolute bottom-4 left-4 flex flex-wrap gap-2">
                    ...
                    {Number(course.price_rupees || 0) > 0 && (
                      <span className="inline-flex items-center gap-1 bg-orange-600 px-3 py-1.5 rounded-xl text-xs font-black text-white shadow-lg shadow-orange-500/20">
                        <Wallet className="h-3.5 w-3.5" /> ₹{course.price_rupees}
                      </span>
                    )}
                   </div>
                </div>
                  ...
                  {Number(course.price_rupees || 0) > 0 && (
                    <div className="mb-4 rounded-2xl border border-orange-500/20 bg-orange-500/10 p-3 text-xs text-orange-200">
                      <div className="flex items-center justify-between gap-2 font-bold">
                        ...
                        <span>₹{balance_rupees.toFixed(2)}</span>
                      </div>
                      <p className="mt-1 text-orange-300/80">Course price: ₹{course.price_rupees}</p>
                    </div>
                  )}
                  <Link 

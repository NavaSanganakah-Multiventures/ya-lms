        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {data.enrolledBooks.map((book: any) => (
              <Link key={book.id} href={`/dashboard/books/${book.id}`} className="group flex flex-col bg-neutral-900 border border-neutral-800 rounded-3xl overflow-hidden hover:border-amber-500/50 transition-all hover:shadow-2xl hover:shadow-amber-500/10">

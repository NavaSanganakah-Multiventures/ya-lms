        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5">
          <div className="space-y-2">
            ...
            <div className="rounded-2xl border border-neutral-800 bg-neutral-950/80 p-3 space-y-3">
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-blue-200">Primary products data source create karein</p>
                <p className="text-[11px] text-neutral-500 mt-1">JSON credentials configured hone ke baad source create/fetch yahin se karein.</p>
              </div>

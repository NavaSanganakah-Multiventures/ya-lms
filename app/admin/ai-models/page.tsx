      ...
      <div className="flex justify-between items-end mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight flex items-center gap-3">
            <Bot className="w-8 h-8 text-orange-500" /> AI ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ®ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¡ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ²ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¸ (AI Models)
          </h1>
          <p className="text-neutral-400 mt-2 text-sm">ÃÂ ÃÂ¤ÃÂ®ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂ¡ÃÂ ÃÂ¤ÃÂ²ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂ¸ Workers AI binding (env.AI) ÃÂ ÃÂ¤ÃÂ¸ÃÂ ÃÂ¥ ÃÂ ÃÂ¤ÃÂ¸ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂ§ÃÂ ÃÂ¥ ÃÂ ÃÂ¤ÃÂ ÃÂ¤ÃÂ²ÃÂ ÃÂ¤ÃÂ¤ÃÂ ÃÂ¥ ÃÂ ÃÂ¤ÃÂ¹ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂ ÃÂ¢ ÃÂ ÃÂ¤ÃÂ¤ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂµÃÂ ÃÂ¤ÃÂ¸ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂ¦ ÃÂ ÃÂ¤ÃÂ ÃÂ¤ÃÂ°ÃÂ ÃÂ¤ÃÂ¤ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂ°ÃÂ ÃÂ¥ ÃÂ ÃÂ¤ÃÂ¹ÃÂ ÃÂ¥ ÃÂ ÃÂ¤ÃÂ¨ÃÂ ÃÂ¤ÃÂ¹ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂÃÂ ÃÂ¥ÃÂ¤ Model ID ÃÂ ÃÂ¤ÃÂ ÃÂ¤ÃÂªÃÂ ÃÂ¤ÃÂ¨ÃÂ ÃÂ¥ÃÂ¾ <strong>@cf/...</strong> ÃÂ ÃÂ¤ÃÂµÃÂ ÃÂ¤ÃÂ¾ÃÂ ÃÂ¤ÃÂ²ÃÂ ÃÂ¤ÃÂ¾ ÃÂ ÃÂ¤ÃÂ¹ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂ¨ÃÂ ÃÂ¤ÃÂ¾ ÃÂ ÃÂ¤ÃÂ ÃÂ¤ÃÂ¾ÃÂ ÃÂ¤ÃÂ¹ÃÂ ÃÂ¤ÃÂ¿ÃÂ ÃÂ¤ÃÂ (ÃÂ ÃÂ¤ÃÂ ÃÂ¤ÃÂªÃÂ ÃÂ¤ÃÂ²ÃÂ ÃÂ¤ÃÂ¬ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂ§: 5 ÃÂ ÃÂ¤ÃÂ°ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂªÃÂ ÃÂ¤ÃÂ¯ÃÂ ÃÂ¤ÃÂ¾/ÃÂ ÃÂ¤ÃÂ°ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂµÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂ¸ÃÂ ÃÂ¥ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂ ÃÂ ÃÂ¤ÃÂ«ÃÂ ÃÂ¥ÃÂ ÃÂ¤ÃÂ°)ÃÂ ÃÂ¥ÃÂ¤</p>
        </div>
        <button
          onClick={() => {
            setEditingModel(null);
        ...
        >
          <Plus className="w-4 h-4 mr-2" /> ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¾ ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ®ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¡ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ² ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¡ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¼ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <div className="flex items-center text-xs text-neutral-500 mt-1 space-x-2">
                  ...
                  {model.is_active === 1 ? (
                    <span className="text-green-500">ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Active</span>
                  ) : (
                    <span className="text-red-500">ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Inactive</span>
                  )}
                </div>
              </div>
            </div>
        ...
        {models.length === 0 && (
          <div className="col-span-full py-12 text-center text-neutral-500">
            ...
            <p>ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ AI ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ®ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¡ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ² ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¹ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ®ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¿ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ²ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¾ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂ¤ ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂªÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¾ ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¾ ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ®ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¡ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ² ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¡ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¼ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂ¤</p>
          </div>
        )}
      </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 md:p-8 max-w-lg w-full shadow-2xl relative">
            <h2 className="text-2xl font-bold text-white mb-6">
              {editingModel ? 'AI ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ®ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¡ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ² ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂªÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¡ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ°ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ' : 'ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¨ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¯ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¾ AI ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ®ÃÂÃÂ ÃÂÃÂ¥ÃÂÃÂÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ¡ÃÂÃÂ ÃÂÃÂ¤ÃÂÃÂ²'}
            </h2>

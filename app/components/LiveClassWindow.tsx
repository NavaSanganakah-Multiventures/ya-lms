...
export default function LiveClassWindow({ roomId, sessionId, isAdmin = false, onClose }: { 
  ...
  useEffect(() => {
    // If the user navigates to a different page, auto-minimize
  ...
  return (
    <div className={
      isMinimized
      ? "fixed bottom-4 right-4 w-[280px] h-[160px] md:w-[320px] md:h-[180px] bg-neutral-950 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] z-[9999] overflow-hidden flex flex-col border-2 border-neutral-800 transition-all hover:scale-105 cursor-pointer group"
      : "fixed inset-0 bg-neutral-950 z-[100] flex flex-col font-sans overflow-hidden"
      ...
      <div className={`flex-1 ${isMinimized ? 'pointer-events-none' : ''}`}>
